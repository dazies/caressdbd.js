module.exports = ({
 ...
 $onlyPerms[ban;{title: :mg_reactno: Error!} {description: Not enough rights! Required rights - \`Administrator or ban\`} {color: $getVar[errorcol]}]
$onlyBotPerms[ban;{title: Error} {description: Bot doesn't have ban permissions/Bot role below user role} {color: #fc0000}]
 `
})